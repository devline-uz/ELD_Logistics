-- ONEBOOK ELD lokal sxemasi, schemaVersion = 2.
...
CREATE TABLE "violations" ("id" TEXT NOT NULL, "type" TEXT NOT NULL, "severity" TEXT NOT NULL DEFAULT 'violation', "occurred_at" TEXT NOT NULL, "log_date" TEXT NULL, "daily_log_id" TEXT NULL, "driver_id" TEXT NULL, "unit_id" TEXT NULL, "policy_version_id" TEXT NULL, "details" TEXT NOT NULL DEFAULT '{}', "resolved_at" TEXT NULL, "resolved_reason" TEXT NULL, "updated_at" TEXT NOT NULL, PRIMARY KEY ("id"));
