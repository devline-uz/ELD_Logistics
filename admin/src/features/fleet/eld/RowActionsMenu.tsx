/**
 * Qator `···` amallar menyusi (fe-screens §1) — `units/RowActionsMenu.tsx`
 * bilan bir xil naqsh (`components/ui`da umumiy variant hali yo'q, shu
 * modulda ham mustaqil nusxa saqlanadi — W2: fayl egaligi bo'yicha alohida).
 */
