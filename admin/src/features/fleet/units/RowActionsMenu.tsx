/**
 * Qator `···` amallar menyusi (fe-screens §1). `components/ui` da umumiy
 * variant hali yo'q — bu modul ichida minimal, klaviatura bilan to'liq
 * boshqariladigan popover sifatida amalga oshirilgan.
 */
